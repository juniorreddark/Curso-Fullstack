...
class ProdutoController extends Controller
{
    ...
    {   
        ...
        if ($request->hasFile('foto')) {
            $logoPath = $request->file('foto')->store('fotos', 'public'); // Armazenar a imagem na pasta 'public/logos'
        } else {
        ...
        $empresa->preco = $request->preco;
        $empresa->descricacao = $request->descricacao;
        $produto->foto = $logoPath;
        $produto->save();
